...
function BlogContainerMask({ children }: { children: React.ReactNode }) {
    return (
        <div className="relative  mx-auto max-h-96 overflow-hidden group border rounded-md  border-primary hover:scale-[1.01] hover:rounded-lg transition-all ease-in-out duration-75">
            {children}
