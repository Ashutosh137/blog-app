    ...
    <nav className="bg-bgSecondary text-white p-4">
      <div className="container mx-auto p-5 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6 items-center">
          <div
            className="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 px-3 py-2 rounded"
          ...
          {isLogin && (
            <>
              ...
              <div
                className="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 px-3 py-2 rounded"
                onClick={() => handleNavigation(`/Profile/${userdata._id}`)}
              >
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden ${isOpen ? "block" : "hidden"} transition-transform animate-swip duration-300 ease-in-out transform ${isOpen ? "translate-x-0" : "translate-x-full"} bg-gray-800 fixed top-0 right-0 w-64 h-full z-50`}
      >
        <div className="p-4 space-y-4">
          <div
            className="flex items-center space-x-2 cursor-pointer text-gray-200 hover:bg-gray-700 px-3 py-2 rounded"
            onClick={() => handleNavigation("/")}
          >
            <BiHome className="text-2xl" title="Home" />
            <span>Home</span>
